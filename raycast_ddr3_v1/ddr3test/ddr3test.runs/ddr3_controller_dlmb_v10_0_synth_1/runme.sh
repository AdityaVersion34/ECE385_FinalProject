...
HD_PWD='C:/Users/Aditya/ece385/final_project/ddr3_test/ddr3test/ddr3test.runs/ddr3_controller_dlmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr3_controller_dlmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddr3_controller_dlmb_v10_0.tcl
